public class GameEventLinkedList implements Comparable<GameEventLinkedList>{
    private GameEventNode head;
    private int size;

    public GameEventLinkedList(){
        this.head = null;
        this.size = 0;
    }
    ...
    public GameEventLinkedList pop(String eventType){
        GameEventNode current = head;
        GameEventNode lastNode = null;
        GameEventLinkedList list = new GameEventLinkedList();
    ...
    @Override
    public int compareTo(GameEventLinkedList otherList){
